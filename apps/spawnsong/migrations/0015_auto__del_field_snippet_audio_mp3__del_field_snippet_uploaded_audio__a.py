...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Snippet.audio_mp3'
        db.delete_column(u'spawnsong_snippet', 'audio_mp3')

        # Deleting field 'Snippet.uploaded_audio'
        db.delete_column(u'spawnsong_snippet', 'uploaded_audio')

        # Adding field 'Snippet.audio'
        db.add_column(u'spawnsong_snippet', 'audio',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Audio'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Snippet.audio_mp3'
        db.add_column(u'spawnsong_snippet', 'audio_mp3',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Snippet.uploaded_audio'
        db.add_column(u'spawnsong_snippet', 'uploaded_audio',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)

        # Deleting field 'Snippet.audio'
        db.delete_column(u'spawnsong_snippet', 'audio_id')
    ...
    models = {
        ...
        u'spawnsong.order': {
            ...
            'security_token': ('django.db.models.fields.CharField', [], {'default': "'db236b139d174aec'", 'max_length': '16'}),
