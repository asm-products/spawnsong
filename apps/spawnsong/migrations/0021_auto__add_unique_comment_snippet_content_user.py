...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Comment', fields ['snippet', 'content', 'user']
        db.create_unique(u'spawnsong_comment', ['snippet_id', 'content', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Comment', fields ['snippet', 'content', 'user']
        db.delete_unique(u'spawnsong_comment', ['snippet_id', 'content', 'user_id'])
    ...
    models = {
        ...
        u'spawnsong.order': {
            ...
            'security_token': ('django.db.models.fields.CharField', [], {'default': "'a48fe5b7e1044772'", 'max_length': '16'}),
