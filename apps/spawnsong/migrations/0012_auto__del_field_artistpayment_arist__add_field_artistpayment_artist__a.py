...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArtistPayment.arist'
        db.delete_column(u'spawnsong_artistpayment', 'arist_id')

        # Adding field 'ArtistPayment.artist'
        db.add_column(u'spawnsong_artistpayment', 'artist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['spawnsong.Artist']),
                      keep_default=False)

        # Adding field 'ArtistPayment.paid_at'
        db.add_column(u'spawnsong_artistpayment', 'paid_at',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ArtistPayment.arist'
        raise RuntimeError("Cannot reverse this migration. 'ArtistPayment.arist' and its values cannot be restored.")
        # Deleting field 'ArtistPayment.artist'
        db.delete_column(u'spawnsong_artistpayment', 'artist_id')

        # Deleting field 'ArtistPayment.paid_at'
        db.delete_column(u'spawnsong_artistpayment', 'paid_at')
    ...
    models = {
        ...
        u'spawnsong.order': {
            ...
            'security_token': ('django.db.models.fields.CharField', [], {'default': "'009f49bc53de4aca'", 'max_length': '16'}),
