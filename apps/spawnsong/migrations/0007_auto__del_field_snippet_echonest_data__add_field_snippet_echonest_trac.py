...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Snippet.echonest_data'
        db.delete_column(u'spawnsong_snippet', 'echonest_data')

        # Adding field 'Snippet.echonest_track_profile'
        db.add_column(u'spawnsong_snippet', 'echonest_track_profile',
                      self.gf('jsonfield.fields.JSONField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Snippet.echonest_track_analysis'
        db.add_column(u'spawnsong_snippet', 'echonest_track_analysis',
                      self.gf('jsonfield.fields.JSONField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Snippet.echonest_data'
        db.add_column(u'spawnsong_snippet', 'echonest_data',
                      self.gf('jsonfield.fields.JSONField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Snippet.echonest_track_profile'
        db.delete_column(u'spawnsong_snippet', 'echonest_track_profile')

        # Deleting field 'Snippet.echonest_track_analysis'
        db.delete_column(u'spawnsong_snippet', 'echonest_track_analysis')
