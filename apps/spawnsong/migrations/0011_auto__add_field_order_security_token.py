...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.security_token'
        db.add_column(u'spawnsong_order', 'security_token',
                      self.gf('django.db.models.fields.CharField')(default='b52aca4e87f747ef', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.security_token'
        db.delete_column(u'spawnsong_order', 'security_token')
    ...
    models = {
        ...
        u'spawnsong.order': {
            ...
            'security_token': ('django.db.models.fields.CharField', [], {'default': "'8f118abd1498495a'", 'max_length': '16'}),
