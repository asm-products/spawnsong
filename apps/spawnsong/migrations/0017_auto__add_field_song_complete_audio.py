...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.complete_audio'
        db.add_column(u'spawnsong_song', 'complete_audio',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Audio'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Song.complete_audio'
        db.delete_column(u'spawnsong_song', 'complete_audio_id')
    ...
    models = {
        ...
        u'spawnsong.order': {
            ...
            'security_token': ('django.db.models.fields.CharField', [], {'default': "'d35d6ea71ee54e0d'", 'max_length': '16'}),
