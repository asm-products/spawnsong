...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.purchaser_email'
        db.add_column(u'spawnsong_order', 'purchaser_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)


        # Changing field 'Order.purchaser'
        db.alter_column(u'spawnsong_order', 'purchaser_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Deleting field 'Order.purchaser_email'
        db.delete_column(u'spawnsong_order', 'purchaser_email')


        # User chose to not deal with backwards NULL issues for 'Order.purchaser'
        raise RuntimeError("Cannot reverse this migration. 'Order.purchaser' and its values cannot be restored.")
