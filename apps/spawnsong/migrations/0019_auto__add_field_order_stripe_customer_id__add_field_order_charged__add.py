...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.stripe_customer_id'
        db.add_column(u'spawnsong_order', 'stripe_customer_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Order.charged'
        db.add_column(u'spawnsong_order', 'charged',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Order.charge_failed'
        db.add_column(u'spawnsong_order', 'charge_failed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Order.charge_error'
        db.add_column(u'spawnsong_order', 'charge_error',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.stripe_customer_id'
        db.delete_column(u'spawnsong_order', 'stripe_customer_id')

        # Deleting field 'Order.charged'
        db.delete_column(u'spawnsong_order', 'charged')

        # Deleting field 'Order.charge_failed'
        db.delete_column(u'spawnsong_order', 'charge_failed')

        # Deleting field 'Order.charge_error'
        db.delete_column(u'spawnsong_order', 'charge_error')
    ...
    models = {
        ...
        u'spawnsong.order': {
            ...
            'security_token': ('django.db.models.fields.CharField', [], {'default': "'7995ab2f7b164643'", 'max_length': '16'}),
