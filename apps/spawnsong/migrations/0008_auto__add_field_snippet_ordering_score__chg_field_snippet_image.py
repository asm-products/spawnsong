...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snippet.ordering_score'
        db.add_column(u'spawnsong_snippet', 'ordering_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Snippet.image'
        db.alter_column(u'spawnsong_snippet', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Snippet.ordering_score'
        db.delete_column(u'spawnsong_snippet', 'ordering_score')


        # Changing field 'Snippet.image'
        db.alter_column(u'spawnsong_snippet', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
