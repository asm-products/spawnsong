...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snippet.processing_error'
        db.add_column(u'spawnsong_snippet', 'processing_error',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snippet.processing_error'
        db.delete_column(u'spawnsong_snippet', 'processing_error')
